...
* 13C-Na-Oxalate
* 12C
* H2O (see general effect of C addition)
...
* Sieved soil stored over night while soil moisture levels were determined.
* 15g of soil dry weight added to each  microcosm.
...
__MicrocosmID = [treatment]\_[rep#]__
...
* The other substrates weighed by mg needed per microcosm * number_replicates
	* Added to 1.5? ml Eppendorf tube
...
1. 44 2/3% gauge needles (you'll inevitably bend lots of them during the gassing process)
...
__2ml-vial-ID = [sample#]\_[microcosmID]\_[day]\_[time]__
...
1. Stick a needle into the edge of the stopper of a 2 mL vial. 
	* Repeat until you have 6 vials with needles sticking out of them.
	* __NOTE:__ Goal for puncturing the septa is to keep it minimumal. More punctures = more chances for gas to escape.
1. Put vial on a needle on the gassing manifold, set timer for 5 min.
1. When removing vial after flushing, make sure both needles are pulled out at the exact same time. 
1. Repeat until all vials are flushed (Can only flush 6 at a time on the manifold)
	* Remaining vials will be: 2 vials of He blank, 2 of air, and 7 for the std curve
...
1. Flush these vials the same way the 2 mL vials are flushed (except flush them for 20 min instead of 5 min) 
	* __NOTE:__ I usually let these flush while I'm sampling gases from the microcosm flasks. 
	Then they're finished and rippin', roarin', ready to go when you're done sampling!
...
1. __VERY FAST:__ open stop cock and push the syringe plunger to your desired volume. 
	* This allows the gas to come to 1atm which is very important for knowing exactly how much gas is in each std.
1. Add gas volume to pre-evacuated 10 ml vial.
1. Inject 250 uL of each of the stds (from the 10 mL vials) into the 2 mL vials. 

#### Sampling microcosms

1. Use 0.5 mL gas tight syringe (with green/red stop cock) 
1. Push needle through 18 gauge sampling port and visually check to make sure the needle is all the way in. 
...
1. Note what time you finished sampling. This is very important because data is based on hourly rates. 
...
* Make sure you turn off all the gas tanks and you're done!
...
1. Did you turn off the gases? 
1. Did you turn of all of the gases (except the GCMS)?
