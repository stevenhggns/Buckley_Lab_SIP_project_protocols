# Notes on conducting the 2nd Full C-cycle microcosm experiment (ag vs meadow vs forest soils)
...
* ml CO2 gas standard in each vial:
	* Tank (%CO2) : volume (ml)
	...
	1. 5% : 4
	1. 5% : 8
	1. 100% : 1  (if respiration rates are high)
...
1. For a cycle of vacuuming and gassing:
	...
	* Vacuum for: >=10 sec (if 2 ml vials) or >=20 sec (if 10 ml vials)
	* Close vacuum valve.
	* Open gas valve.
	* Gas for: >=10 sec (if 2 ml vials) or >=20 sec (if 10 ml vials)
...
* Use 1 mL and 10 mL stopcock gastight syringes to make the stds. 
...
1. Push needle through 18 gauge sampling port and visually check
   to make sure the needle is all the way through the stopper. 
